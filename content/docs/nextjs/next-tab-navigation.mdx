...
description: nextjs에서 tab 내비게이션을 구현하는 방법에 대해 알아봅니다.
tags: [Next.js, routing, navigation, use-case]
---
...
[nextjs catch-all segments](https://nextjs.org/docs/app/api-reference/file-conventions/dynamic-routes#catch-all-segments)
[nextjs parallel routes](https://nextjs.org/docs/app/api-reference/file-conventions/parallel-routes)