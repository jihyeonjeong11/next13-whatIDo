...
[SI에서 Nextjs 첫 프로젝트 반성 및 후기](/docs/needsReview/SI에서 Nextjs 첫 프로젝트 반성 및 후기) 에서 Nextjs 프로젝트 아키텍쳐를 담당하며 ai의 도움을 많이 받았다. 가장 고민했었던 부분은 **최대한의 개발속도를 확보하기 위해 어떻게 레거시한 베이들을 건드리지 않고 Nextjs를 최대한 React 스럽게 개발할 수 있을까?** 였고 여기서 파생되는 고민들에 대해서 Cursor와 Claude cli가 정말 큰 도움이 되었다.
