...
description: Fumadocs를 Nextjs 프로젝트에 셋업하는 방법에 대해 알아봅니다.
tags: [Fumadocs, documentation, setup, conceptual]
---
...
앞으로는 포트폴리오 사이트를 통해 계속해서 이 docs의 내용을 늘려나갈 계획이다. 앞으로는 더 많은 use-case를 발견하고 추가해 나갈 것이 기대된다.
